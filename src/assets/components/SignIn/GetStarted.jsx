      ...
      <div className="flex">
        <div className="my-16 mb-12 p-0 list-none w-[60%]">
          <div className="mr-50 mt-20 ml-12">
            ...
            <p className="mb-16">Personalize your set-up accordingly</p>
          </div>
        ...
        {isSignInBoxClicked && (
          <div className="my-16 mb-12 p-0 w-[40%] bg-white">
            <section>
              <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
                <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                  <div className="mb-2 flex justify-center">
                    <h1 className="text-4xl text-bold">StudentView</h1>
                  </div>
